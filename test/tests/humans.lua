return function()
	...
	local man = humans.create(Vector(), RotMatrix(1, 0, 0, 0, 1, 0, 0, 0, 1), players[0])
	assert(man.isActive)
	...
	nextTick(function()
		...
		local man = humans.create(Vector(100, 50, 100), RotMatrix(1, 0, 0, 0, 1, 0, 0, 0, 1), bot)
	...
	do
		local item = items.create(itemTypes[0], Vector(), RotMatrix(1, 0, 0, 0, 1, 0, 0, 0, 1))
